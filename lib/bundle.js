 ...
 */
var EmailServices = ({ to, text, subject = 'Mail from tutable app' }) => new Promise((resolve, reject) => {
...
const SlackRequestInterceptor = (req, res, next) => {
	...
	winston.createLogger({
		level: 'info',
		format: winston.format.json(),
		transports: new slackWinston.Slack({
			domain: '',
			token: SLACK_TOKEN,
 ...
 */
const {
	TWILIO_ACCOUNT_SID: TWILIO_ACCOUNT_SID$1,
	TWILIO_AUTH_TOKEN: TWILIO_AUTH_TOKEN$1,
	TWILIO_PHONE: TWILIO_PHONE$1,
	STRIPE_SECRET_KEY: STRIPE_SECRET_KEY$1,
	AWS_ACCESSID: AWS_ACCESSID$1,
	AWS_SECRET: AWS_SECRET$1,
	S3_BUCKET: S3_BUCKET$1,
	BUSINESS_EMAIL: BUSINESS_EMAIL$2,
	BUSINESS_EMAIL_PASSWORD: BUSINESS_EMAIL_PASSWORD$2,
} = process.env;
// export default ({
// 	loadTwilio = true,
// 	loadS3 = true,
